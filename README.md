...
- [bddicken/languages](https://github.com/bddicken/languages) - Compare languages (today)
- [Nutlope/llama-ocr](https://github.com/Nutlope/llama-ocr) - Document to Markdown OCR library with Llama 3.2 vision (2 days ago)

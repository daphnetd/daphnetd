...
- [cordiverse/paper](https://github.com/cordiverse/paper) - A Programming Paradigm for Spatiotemporal Composability (today)
- [yc-software/qm](https://github.com/yc-software/qm) - Multiplayer agent harness for work. (1 day ago)
- [QwenLM/Qwen-MM-Plugins](https://github.com/QwenLM/Qwen-MM-Plugins) - Make any agent harness multimodal-native. (4 days ago)

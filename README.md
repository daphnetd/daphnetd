...
- [1weiho/open-slide](https://github.com/1weiho/open-slide) - A slide framework built for agents. (6 days ago)
...
- [EvoLinkAI/awesome-gpt-image-2-API-and-Prompts](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts) - GPT-Image-2 API and Prompts (2 weeks ago)
- [QuipNetwork/quip-protocol-rs](https://github.com/QuipNetwork/quip-protocol-rs) - A rust implementation of the Quip Protocol forked from Substrate (2 weeks ago)
